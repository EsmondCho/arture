...
class User(models.Model):
    ...
    pic = models.ImageField(null=True, upload_to="profile_pictures", default='profile_pictures/default_profile_picture/default.png')
    ...
    def save(self, force_insert=False, force_update=False, using=None):
        for field in self._meta.fields:
            if field.name == 'pic':
                field.upload_to = 'profile_pictures/%s' % self.email
